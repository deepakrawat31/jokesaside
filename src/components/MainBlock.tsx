export default function MainBlock() {
  return (
    <div className="motion-preset-fade-lg col-span-1 row-span-1 flex flex-col gap-4 rounded-lg bg-neutral-900 p-4 motion-ease-spring-smooth md:col-span-3 md:row-span-3">
